...
export const journalEntries = [
  ...
  {
    label: "Field Note 8",
    slug: "dont-hire-another-laptop-fix-the-lockfile",
    ...
    dateISO: "2026-09-21",
    excerpt:
      "A field note about headcount, hidden clocks, clean handoffs, and why teams should count closed loops before counting people.",
    comingSoon: false,
    sections: [
      `What This Is About`,
    ...
    relatedLinks: [
      {
        label: "Journal",
        title: "The Ghost House and the Math Boogeyman",
        href: "/journal/the-ghost-house-and-the-math-boogeyman",
      },
      {
        label: "Journal",
        title: "The Silent Killer of Property Management Operations",
      ...
      {
        label: "Work",
        title: "PM Ops Map: the operating map before the product",
        href: "/work/pm-ops-map",
      },
    ],
  },
...
export const journalStrongLines = new Set([
  ...
  "That kind of system does not need another laptop. It needs a lockfile.",
  "It worked when the person with the history touched it. It failed when a stranger had to run it from the instructions.",
  "Hiring adds doing time. That matters. But doing time is only one clock.",
  "The work moved, but the trail did not.",
  "A group chat is not a database. It is a conversation with a search bar and a bad memory.",
  "Do we need more hands, or do we need the system to remember where the hands left off?",
